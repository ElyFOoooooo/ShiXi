...
from activate import Chen
from dataset import ImageTxtDataset
from model import *
# from test import transform

# 准备数据集
train_data = ImageTxtDataset(r"D:\桌面\shixun\Deep_Learning_Basics\dataset\train.txt",
                             r"D:\桌面\shixun\Deep_Learning_Basics\dataset\image2\train",
                             #数据增强
